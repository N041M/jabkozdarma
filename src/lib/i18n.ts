...
const en = {
  ...
  sendError: 'Couldn’t send the code — check the email address and try again.',
...
const cs: typeof en = {
  ...
  sendCode: 'Poslat kód na e-mail',
  sendingCode: 'Odesílám…',
  codeSentTo: 'Poslali jsme šestimístný kód na {email}.',
  codePlaceholder: 'Kód z e-mailu',
  verifyCode: 'Přihlásit se',
  verifyingCode: 'Ověřuji…',
  authError: 'To nevyšlo — zkontrolujte kód a zkuste to znovu.',
  sendError: 'Kód se nepodařilo odeslat — zkontrolujte e-mailovou adresu a zkuste to znovu.',
